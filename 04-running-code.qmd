...
[Insert Screenshot: Run Button in RStudio]

Show the Run button in the Source Pane.
...
## Method 4: Run an Entire Script

To run an entire script, you can:

1. Open your `.R` file.
2. Click **Source**.
3. RStudio will run the whole script from top to bottom.

<div class="screenshot-placeholder">

[Insert Screenshot: Source Button]

Show the Source button for running an entire R script.
...
## Running Code in a Quarto Document

In a Quarto document, code usually appears inside a code chunk.
...
[Insert Screenshot: Running a Quarto Code Chunk]

Show the green play button next to a code chunk.
...
When you render a Quarto document, R runs the code chunks from top to bottom.
:::
